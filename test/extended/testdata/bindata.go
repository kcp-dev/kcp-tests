...
// sources:
// test/extended/testdata/placement/placement.yaml
...
var _testExtendedTestdataPlacementPlacementYaml = []byte(`apiVersion: scheduling.kcp.dev/v1alpha1
kind: Placement
metadata:
  name: "$(NAME)"
spec:
  ...
  locationSelectors:
    - {}
  locationWorkspace: "$(LOCATION_WORKSPACE)"
  namespaceSelector: {}`)

func testExtendedTestdataPlacementPlacementYamlBytes() ([]byte, error) {
	return _testExtendedTestdataPlacementPlacementYaml, nil
}

func testExtendedTestdataPlacementPlacementYaml() (*asset, error) {
	bytes, err := testExtendedTestdataPlacementPlacementYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "test/extended/testdata/placement/placement.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
var _bindata = map[string]func() (*asset, error){
	"test/extended/testdata/placement/placement.yaml": testExtendedTestdataPlacementPlacementYaml,
	...
	"test": {nil, map[string]*bintree{
		"extended": {nil, map[string]*bintree{
			"testdata": {nil, map[string]*bintree{
				"placement": {nil, map[string]*bintree{
					"placement.yaml": {testExtendedTestdataPlacementPlacementYaml, map[string]*bintree{}},
				}},
